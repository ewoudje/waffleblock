...
public interface FlywheelEffectComponent extends Effect {
    GridComponentType<ClientGrid, FlywheelEffectComponent> TYPE = new GridComponentType<>(FlywheelEffectComponent.class, FlywheelEffectComponent::onAdd, FlywheelEffectComponent::onRemove);
